...
{
    // RiddlesModel.cshtml.cs
    public class RiddlesModel : PageModel
    {
        private List<Riddle> riddles = new List<Riddle>
        {
             ...
             new Riddle { Question = "What comes once in a minute, twice in a moment, but never in a thousand years?", Answer = "Letter" },
